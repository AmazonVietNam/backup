        ...
        <div class="row">
            <div class="col-lg-7 col">
                <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
					...
					<marquee width="90%" direction="left" style="padding-top:5px;" >					
					AMAZONVIETNAM.COM.VN - KHẲNG ĐỊNH ĐẲNG CẤP CỦA BẠN &nbsp; &nbsp; &nbsp; &nbsp; CHC GROUP - Ngôi Nhà Của Trung Tâm Thành Phố
					</marquee>
                </ul>
            </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="align-items-center">
                    <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                        ...
                        <div class="d-none d-xl-block align-self-stretch category-menu-icon-box" style="margin-top:20px">
                            <div class="h-50 d-flex align-items-center" id="category-menu-icon">
                                <div class="dropdown-toggle navbar-light bg-light h-42px w-60px pl-2 rounded border c-pointer">
                                    <span style="color:black;">All&nbsp;</span><span class="navbar-toggler-icon"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                            <div class="d-flex position-relative align-items-center">
                                ...
                                <div class="input-group">
                                    <input type="text" class="border-0 border-lg form-control" onfocus="inputFocus(this)" onblur="inputBlur(this)" id="search" name="q" placeholder="{{translate('I am shopping for...')}}">
				...
				{{-- <div class="d-none d-lg-block ml-3 mr-0">
                    <div class="" >
                       <a href="#" style="color:white" ><img src="https://89bay.com.vn/doc/images/muiten.gif" height=30px;/><b>Affiliate</b></a>
                    </div>
                </div> --}}
            ...
            <div class="container">
                <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center">
                    <li class="list-inline-item mr-0">
                        <a href="https://news.amazonvietnam.com.vn/category/khuyen-mai" class="opacity-80 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                            Khuyến mại !
                        </a>
                    </li>
                                        <li class="list-inline-item mr-0">
                        <a href="https://news.amazonvietnam.com.vn" class="opacity-80 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                            Tin tức
                        </a>
                    </li>
                                        <li class="list-inline-item mr-0">
                        <a href="/brands" class="opacity-80 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                            Tất cả các thương hiệu
                        </a>
                    </li>
                                        <li class="list-inline-item mr-0">
                        <a href="/categories" class="opacity-80 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                            Tất cả danh mục
                        </a>
                    </li>
                </ul>
