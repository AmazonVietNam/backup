                                ...
                                @foreach (Auth::user()->addresses as $key => $address)
                                    <div class="col-lg-6">
                                        <div class="border p-3 pr-5 rounded mb-3 position-relative">
                                            ...
                                            <div>
                                                <span class="w-50 fw-600">{{ translate('Ward') }}:</span>
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select id="sl_country" class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select your country')}}" name="country" required>
                        ...
                        <div class="row">
                            <label class="col-md-2 col-form-label">{{ translate('Ward')}}</label>
                            <div class="col-md-10">
                                <div class="mb-3">
