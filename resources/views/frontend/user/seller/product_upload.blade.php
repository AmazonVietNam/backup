                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label" style="font-weight: bold;">{{translate('Product Name')}} <span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="{{ old('name') }}" name="name" placeholder="{{ translate('Product Name') }}" onchange="update_sku()" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" id="brand">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control aiz-selectpicker" name="brand_id" id="brand_id"  data-live-search="true">
                                            ...
                                            @foreach (\App\Brand::where('category', 'Thương hiệu')->get() as $brand)
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="{{ old('unit') }}" name="unit" placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Weight')}} <span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="{{ old('weight') ?? '0' }}" name="weight" value="0" placeholder="{{ translate('Weight') }}" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Minimum Qty')}} <span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                                        <input type="number" class="form-control" value="{{ old('min_qty') }}" name="min_qty" value="1" min="1" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Tags')}} <span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control aiz-tag-input" placeholder=""name="tags[]" placeholder="{{ translate('Type and hit enter to add a tag') }}">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                    <div class="custom-file">
                                        <label class="custom-file-name custom-file-label" for="customFile">{{ translate('Choose File') }}</label>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" min="0" value="{{ old('unit_price') ?? '0' }}" step="0.01" placeholder="{{ translate('Unit price') }}" name="unit_price" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Purchase price')}}</label>
                                    <div class="col-md-8">
                                        <input type="number" min="0" value="{{ old('purchase_price') ?? '0' }}" step="0.01" placeholder="{{ translate('Purchase price') }}" name="purchase_price" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Tax')}}</label>
                                    <div class="col-md-8">
                                        <input type="number" min="0" value="{{ old('tax') ?? '0' }}" step="0.01" placeholder="{{ translate('Tax') }}" name="tax" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Discount')}}</label>
                                    <div class="col-md-6">
                                        <input type="number" min="0" value="{{ old('discount') ?? '0' }}" step="0.01" placeholder="{{ translate('Discount') }}" name="discount" class="form-control" >
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row" id="quantity">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" min="0" value="{{ old('current_stock') ?? '0' }}" step="1" placeholder="{{ translate('Quantity') }}" name="current_stock" class="form-control" >
                                    </div>
                                </div>
                                <br>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="number" min="0" value="{{ old('flat_shipping_cost') }}" step="0.01" placeholder="{{ translate('Shipping cost') }}" name="flat_shipping_cost" class="form-control" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="{{ old('meta_title') }}" name="meta_title" placeholder="{{ translate('Meta Title') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Description')}}</label>
