                        ...
                        <div class="card-body">
                            ...
                            <div class="row gutters-5">
                                <div class="col-6">
                                    <div class="">
                                        <div class="form-group">
                                            <select name="poscategory" class="form-control form-control-sm js-select selectpicker" data-live-search="true" onchange="filterProducts()">
                                ...
                                <div class="col-6">
                                    <div class="">
                                        <div class="form-group">
                                            <select name="brand" class="form-control form-control-sm js-select selectpicker" data-live-search="true" onchange="filterProducts()">
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <select name="user_id" class="form-control form-control-sm pos-customer js-select selectpicker" data-live-search="true" onchange="getShippingAddress()">
                                        ...
                                        @if (Session::has('posCart'))
                                            @forelse (Session::get('posCart') as $key => $cartItem)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <button class="btn btn-circle btn-icon btn-danger" type="button" onclick="removeFromCart({{ $key }})">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="d-flex">
                                <div class="dropdown mr-3 dropup">
                                    ...
                                    <div class="dropdown-menu p-3 dropdown-menu-lg-top">
                                ...
                                <div class="dropdown dropup">
                                    ...
                                    <div class="dropdown-menu p-3 dropdown-menu-lg-top">
                                        <div class="input-group width-134">
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="{{ route('addresses.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class=" row">
                                <label class="col-sm-2 control-label" for="sl_country">{{translate('Country')}}</label>
                                <div class="col-sm-10">
                                    <select name="country" id="sl_country" class="form-control js-select selectpicker" data-live-search="true" required data-placeholder="{{translate('Select country')}}">
                        ...
                        <div class="row">
                            <label class="col-md-2 control-label" for="sl_province">{{ translate('Province')}}</label>
                            <div class="col-sm-10">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            <label class="col-md-2 control-label" for="sl_district">{{ translate('District')}}</label>
                            <div class="col-sm-10">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            <label class="col-md-2 control-label" for="sl_ward">{{ translate('Ward')}}</label>
                            <div class="col-sm-10">
                                <div class="mb-3">
