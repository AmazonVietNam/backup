                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class=" row">
                                ...
                                <div class="col-sm-10">
                                    <select name="country" id="sl_country" class="form-control aiz-selectpicker" required data-placeholder="{{translate('Select country')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select id="sl_province" class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select your province')}}" name="province" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select id="sl_district" class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select your district')}}" name="district" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select id="sl_ward" class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select your ward')}}" name="ward" required>
