...
@section('title', translate('Registration'))
                            ...
                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="referral">{{ translate('Referral ID') }}</label>
                                            <input type="text" id="referral" class="form-control" value="{{ $referral }}" disabled>
                                        </div>

										<div class="form-group">
											<input type="radio" id="cn" name="dn_cn" value="cn" checked>&nbsp;<label for="cn">Cá nhân</label>
                                            <input type="text" class="form-control" placeholder="Số CMND hoặc CCCD" name="id_user_code" id="id_user_code">
											<br>
											<input type="radio" id="dn" name="dn_cn" value="dn">&nbsp;<label for="dn">Doanh nghiệp</label>
                                            <input type="text" class="form-control" placeholder="Mã số thuế" name="id_com_code" id="id_com_code">
										</div>
                                        ...
                                        <div class="mb-3">
                                            <label class="aiz-checkbox">
                                                ...
                                                <span class="text-black">{{ translate('By signing up you agree to our terms and conditions.')}}</span>
                                ...
                                <div class="text-center">
                                    <p class="text-gray-60 mb-0">{{ translate('Already have an account?')}}</p>
