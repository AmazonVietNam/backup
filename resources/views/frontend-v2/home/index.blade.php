                        ...
                        <div class="bg-img-hero mr-xl-1 height-410-xl max-width-1060-wd max-width-830-xl overflow-hidden">
                            <div class="js-slick-carousel u-slick" data-autoplay="true" data-speed="7000"
                                ...
                                @if (get_setting('home_slider_images') != null)
                                    ...
                                    <div class="js-slide bg-img-hero-center" style="background-image: url({{ uploaded_asset($slider_images[$key]) }});">
                                ...
                                @if (get_setting('home_banner1_images') != null)
                                    ...
                                    @foreach ($banner_image as $key => $value)
                                        <li class="px-2 px-xl-0 flex-shrink-0 flex-xl-shrink-1 mb-3">
                                            <div
                                                class="min-height-126 max-width-320  banner-bg d-flex align-items-center text-gray-90">
                                                    <img class=" img-fluid"
            ...
            <div class="mb-5  p-4 bg-white">
                <div class="position-relative">
                    ...
                    <div class="js-slick-carousel u-slick position-static overflow-hidden u-slick-overflow-visble pt-2 px-1"
                            ...
                            @foreach (filter_products(\App\Product::where([['published', 1],['featured', '1'],['status', '1']]))->take(20)->get() as $key => $product)
            ...
            <div class="mb-5 bg-white p-5">
                <div class="position-relative">
                    ...
                    <div class="js-slick-carousel u-slick position-static overflow-hidden u-slick-overflow-visble  pt-2 px-1"
                            ...
                            @foreach (filter_products(\App\Product::where([['published', 1],['todays_deal', 1]]))->get() as $key => $product)
                            <div class="js-slide products-group">
                                <div class="product-item mx-1 remove-divider">
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner bg-white px-wd-4 p-2 p-md-3">
                ...
                <div class="row">
                            ...
                            <a href="" class="row align-items-center">
                                <div class="col-md-12">
                                    @if (get_setting('home_banner3_1_images') != null)
                                            @php $banner_3_1_imags = json_decode(get_setting('home_banner3_1_images'), true); @endphp
                                        @foreach ($banner_3_1_imags as $item => $key)
                                            <img class="img-fluid"
                                            src="{{ uploaded_asset(json_decode(get_setting('home_banner3_1_images'), true)[$item]) }}"
                                            alt="Image Description">
                                        @endforeach
                                    @endif
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="h-100">
                            @if (get_setting('home_banner3_2_images') != null)
                                    @php $banner_3_2_imags = json_decode(get_setting('home_banner3_2_images'), true); @endphp
                                @foreach ($banner_3_2_imags as $item => $key)
                                <a href="" class="d-block"><img class="img-fluid"
                                    src="{{uploaded_asset(json_decode(get_setting('home_banner3_2_images'), true)[$item])}}"
                                    alt="Image Description"></a>
                                @endforeach
                            @endif
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        @if (get_setting('home_banner3_3_images') != null)
                                @php $banner_3_3_imags = json_decode(get_setting('home_banner3_3_images'), true); @endphp
                            @foreach ($banner_3_3_imags as $item => $key)
                            <a href="" class="d-block"><img class="img-fluid"
                                src="{{uploaded_asset(json_decode(get_setting('home_banner3_3_images'), true)[$item])}}"
                                alt="Image Description"></a>
                            @endforeach
                        @endif
                    </div>
                            ...
                            <a href="" class="row align-items-center">
                                <div class="col-md-12 mb-4 mb-md-0">
                                    @if (get_setting('home_banner3_4_images') != null)
                                            @php $banner_3_4_imags = json_decode(get_setting('home_banner3_4_images'), true); @endphp
                                        @foreach ($banner_3_4_imags as $item => $key)
                                            <img class="img-fluid"
                                            src="{{ uploaded_asset(json_decode(get_setting('home_banner3_4_images'), true)[$item]) }}"
                                            alt="Image Description">
                                        @endforeach
                                    @endif
                                </div>
