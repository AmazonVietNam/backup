                                    ...
                                    @foreach ($slider_images as $key => $value)
                                        <div class="js-slide bg-img-hero-center">
                                            ...
                                            <div class="row height-410-xl py-7 py-md-0 mx-0">
                                                ...
                                                <div class="col-xl col-6 col-md-6 mt-md-8 text-truncate">
                            ...
                            <ul
                                ...
                                <li class="px-2 px-xl-0 flex-shrink-0 flex-xl-shrink-1 mb-3">
                                    <div
                                        ...
                                        <div class="col col-lg-6 col-xl-5 col-wd-6 mb-3 mb-lg-0 pr-lg-0">
                                            <img class="img-fluid"
                                                src="https://transvelo.github.io/electro-html/2.0/assets/img/246X176/img1.jpg"
                                                alt="Image Description">
                                        </div>
                                ...
                                <li class="px-2 px-xl-0 flex-shrink-0 flex-xl-shrink-1 mb-3">
                                    <div
                                        ...
                                        <div class="col col-lg-6 col-xl-5 col-wd-6 mb-3 mb-lg-0 pr-lg-0">
                                            <img class="img-fluid"
                                                src="https://transvelo.github.io/electro-html/2.0/assets/img/246X176/img2.jpg"
                                                alt="Image Description">
                                        </div>
                                        <div class="col col-lg-6 col-xl-7 col-wd-6 pr-xl-4 pr-wd-3">
                                            <div
                                                class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23 text-uppercase">
                                                Thoả sức <strong>Săn Sale</strong>
                                            </div>
                                            {{-- <div class="link text-gray-90 font-weight-bold font-size-15" href="#">
                                                Shop now
                                                <span class="link__icon ml-1">
                                ...
                                <li class="px-2 px-xl-0 flex-shrink-0 flex-xl-shrink-1 mb-0">
                                    <div
                                        ...
                                        <div class="col col-lg-6 col-xl-5 col-wd-6 mb-3 mb-lg-0 pr-lg-0">
                                            <img class="img-fluid"
                                                src="https://transvelo.github.io/electro-html/2.0/assets/img/246X176/img3.jpg"
                                                alt="Image Description">
                                        </div>
                                        <div class="col col-lg-6 col-xl-7 col-wd-6 pr-xl-4 pr-wd-3">
                                            <div
                                                class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23 text-uppercase">
                                                Cấu hình <strong>khủng</strong> cân ngày hè
                                            </div>
                                            {{-- <div class="link text-gray-90 font-weight-bold font-size-15" href="#">
                                                Shop now
                                                <span class="link__icon ml-1">
                    ...
                    <div class="bg-img-hero pt-3">
                        ...
                        @if (count($banner_2_imags) > 0)
                            <a href="{{ json_decode(get_setting('home_banner2_links'), true)[0] }}"
                                ...
                                <img src="{{ uploaded_asset($banner_2_imags[0]) }}" alt="{{ env('APP_NAME') }} promo"
                                    class="img-fluid">
                            </a>
                        @endif
                    </div>
            ...
            <div class="container">
                    ...
                    <div class="bg-img-hero pt-3">
                            ...
                            <a href="{{ json_decode(get_setting('home_banner2_links'), true)[1] }}"
                                class="d-block text-reset">
                                <img src="{{ uploaded_asset($banner_2_imags[1]) }}" alt="{{ env('APP_NAME') }} promo"
                                    class="img-fluid">
                            </a>
