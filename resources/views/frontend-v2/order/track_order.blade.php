...
@section('title', translate('Track Order'))
        ...
        <div class="row">
            <div class="col-xxl-5 col-xl-6 col-lg-8 mx-auto">
                <div class="text-center">
                    <h1 class="font-weight-bold h4">{{ translate('Track Order')}}</h1>
                </div>
                        ...
                        <div class="col-lg-6">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td>{{ json_decode($order->shipping_address)->address }}, {{ isset(json_decode($order->shipping_address)->ward_name) ? json_decode($order->shipping_address)->ward_name : "" }}, {{ isset(json_decode($order->shipping_address)->district_name) ? json_decode($order->shipping_address)->district_name : "" }}, {{ json_decode($order->shipping_address)->city }}, {{ json_decode($order->shipping_address)->country }}</td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-lg-6">
