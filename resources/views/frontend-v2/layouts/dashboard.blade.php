...
<head>
    ...
    <link rel="stylesheet" href="{{ static_asset('clever/vendor/dropzone/dropzone.min.css') }}">
    <link rel="stylesheet"
        href="{{ static_asset('clever/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}">
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="d-none d-xl-block col-xl-3 col-wd-2gdot5 py-4">
                @include('frontend-v2.inc.sidenav')
            </div>
            <div class="col-xl-9 col-wd-9gdot5 py-4">
    ...
    <script src="{{ static_asset('clever/vendor/dropzone/dropzone.min.js')}}"></script>
