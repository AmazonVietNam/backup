...
<div class="row mb-4">
        ...
        <div class="card card-bg-light rounded-lg overflow-hidden">
            <div class="card-body">
                ...
                <div class="px-3 pt-3 pb-3">
                    <div class="h4 font-weight-bold text-center">{{ single_price(Auth::user()->seller->admin_to_pay) }}</div>
    ...
    <div class="col-md-4 mr-auto">
        <div class="card card-bg-light rounded-lg overflow-hidden text-center h-100" onclick="show_request_modal()">
            <div class="card-body">
...
<div class="card">
    <div class="card-header">
        <h5 class="h6">{{ translate('Withdraw Request history')}}</h5>
    </div>
    <div class="card-body">
        @if($seller_withdraw_requests->count() > 0)
        ...
        {{ $seller_withdraw_requests->links('vendor.pagination.list_product') }}
        @else
