...
<div class="row mb-4">
    <div class="col-md-4 ml-auto" >
        <div class="card card-bg-light rounded-lg overflow-hidden">
            <div class="card-body">
                <span class="size-30px rounded-circle mx-auto bg-soft-primary d-flex align-items-center justify-content-center mt-3">
                    <i class="fas fa-dollar-sign la-2x text-white"></i>
                </span>
                <div class="px-3 pt-3 pb-3">
                    <div class="h4 font-weight-bold text-center">{{ single_price(Auth::user()->balance) }}</div>
    ...
    <div class="col-md-4 mr-auto">
        <div class="card card-bg-light rounded-lg overflow-hidden text-center h-100" onclick="show_wallet_modal()">
            <div class="card-body">
                <span class="size-30px rounded-circle mx-auto bg-secondary d-flex align-items-center justify-content-center mt-3">
    ...
    @if (\App\Addon::where('unique_identifier', 'offline_payment')->first() != null && \App\Addon::where('unique_identifier', 'offline_payment')->first()->activated)
        <div class="col-md-4 mx-auto mb-3" >
            <div class="card card-bg-light rounded-lg overflow-hidden text-center h-100" onclick="show_make_wallet_recharge_modal()">
                <div class="card-body"> 
                    <span class="size-30px rounded-circle mx-auto bg-secondary d-flex align-items-center justify-content-center mb-3">
    ...
    <div class="col-md-4 ml-auto" >
        <div class="card card-bg-light rounded-lg overflow-hidden">
            <div class="card-body">
                ...
                <div class="px-3 pt-3 pb-3">
                    <div class="h4 font-weight-bold text-center">{{ single_price($affiliate_wallet->current_payment_money) }}</div>
                    <div class="opacity-50 text-center">{{ translate('Affiliate Payment Wallet Balance') }}</div>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-4 mr-auto" >
        <div class="card card-bg-light rounded-lg overflow-hidden">
            <div class="card-body">
                ...
                <div class="px-3 pt-3 pb-3">
                    <div class="h4 font-weight-bold text-center">{{ single_price($affiliate_wallet->current_purchase_money) }}</div>
                    <div class="opacity-50 text-center">{{ translate('Affiliate Purchase Wallet Balance') }}</div>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-4 mr-auto">
        <div class="card card-bg-light rounded-lg overflow-hidden text-center h-100" onclick="show_aff_wallet_modal()">
            <div class="card-body">
                <span class="size-30px rounded-circle mx-auto bg-secondary d-flex align-items-center justify-content-center mt-3">
                    <i class="fas fa-plus la-3x text-white"></i>
                </span>
...
<div class="card">
    <div class="card-header">
        <h5 class="h6">{{ translate('Wallet recharge history')}}</h5>
    </div>
    <div class="card-body">
        @if($wallets->count() > 0)
        ...
        {{ $wallets->links('vendor.pagination.list_product') }}
        @else
...
@section('modal')
              ...
              <form class="" action="{{ route('wallet.recharge') }}" method="post">
                  ...
                  <div class="modal-body gry-bg px-3 pt-3">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-8">
                              <div class="mb-3">
                                  <select class="form-control js-select selectpicker" data-minimum-results-for-search="Infinity" name="payment_option" data-live-search="true">
                                    <option value="" disabled>{{translate('Default')}}</option>
  ...
  <div class="modal fade" id="aff_wallet_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ translate('Recharge Wallet') }}</h5>
              ...
              <form class="" action="{{ route('wallet.affiliate_recharge') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="modal-body gry-bg px-3 pt-3">
                      <div class="row">
                          <div class="col-md-4">
                          ...
                          <div class="col-md-8">
                              <input min="0" type="number" class="form-control mb-3" name="amount" placeholder="{{ translate('Amount')}}" required>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-4">
                          ...
                          <div class="col-md-8">
                              <input class="form-control mb-3" name="phone" placeholder="{{ translate('Phone')}}" required>
                          </div>
                      </div>
                      <div class="row mb-3">
                          <div class="col-md-4">
                              <label>{{ translate('Photo')}} <span class="text-danger">*</span></label>
                          </div>
                          <div class="col-md-8">
                            <div class="custom-file">
                                <input name="billImage" type="file" class="custom-file-input" id="customFile">
...
@section('script')
    <script type="text/javascript">
        ...
        function show_aff_wallet_modal(){
            $('#aff_wallet_modal').modal('show');
        }
