    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 ">{{translate('Internet Banking Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        <input type="hidden" name="payment_method" value="paypal">
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="INTERNETBANK_NAME">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Bank Name - CN')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="INTERNETBANK_NAME" value="{{  env('INTERNETBANK_NAME') }}" placeholder="{{ translate('Bank Name - CN') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="INTERNETBANK_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Bank ID')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="INTERNETBANK_ID" value="{{  env('INTERNETBANK_ID') }}" placeholder="{{ translate('Bank ID') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="INTERNETBANK_ACCOUNTNAME">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Account Name')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="INTERNETBANK_ACCOUNTNAME" value="{{  env('INTERNETBANK_ACCOUNTNAME') }}" placeholder="{{ translate('Account Name') }}" required>
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
