	...
	<div>
		...
		<div style="padding: 1.5rem;padding-bottom: 0">
            <table>
				...
				<tr><td class="gry-color small">{{ $shipping_address->address }}, {{ isset($shipping_address->ward_name) ? $shipping_address->ward_name : "" }}, {{ isset($shipping_address->district_name) ? $shipping_address->district_name : "" }}, {{ $shipping_address->city }}, {{ $shipping_address->country }}</td></tr>
