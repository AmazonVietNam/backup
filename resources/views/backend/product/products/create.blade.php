		...
		<div class="card">
			...
			<div class="card-body">
				<div class="form-group row">
					...
					<div class="col-md-8">
						<input type="text" class="form-control" name="{{ old('name') }}" placeholder="{{ translate('Product Name') }}" onchange="update_sku()" >
					</div>
				...
				<div class="form-group row">
					...
					<div class="col-md-8">
						<input type="text" class="form-control" name="weight" value="{{ old('weight') ?? '0' }}" placeholder="{{ translate('Weight') }}" >
					</div>
				</div>
                <div class="form-group row">
					<label class="col-md-3 col-from-label">{{translate('Minimum Qty')}} <span class="text-danger">*</span></label>
					<div class="col-md-8">
						<input type="number" class="form-control" name="min_qty" value="{{ old('min_qty') ?? '1' }}" min="1" >
					</div>
				</div>
				<div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
                <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                    ...
                    <input hidden name="photos" class="selected-files">
                </div>
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="form-group row">
					...
					<div class="col-md-8">
						<input type="number" value="{{ old('unit_price') ?? '0' }}" placeholder="{{ translate('Unit price') }}" name="unit_price" class="form-control" >
					</div>
				</div>
				<div class="form-group row">
					<label class="col-md-3 col-from-label">{{translate('Purchase price')}} <span class="text-danger">*</span></label>
					<div class="col-md-8">
						<input type="number" min="0" value="{{ old('purchase price') ?? '0' }}" step="0.01" placeholder="{{ translate('Purchase price') }}" name="purchase_price" class="form-control" >
					</div>
				</div>
				<div class="form-group row">
					<label class="col-md-3 col-from-label">{{translate('Tax (Percent)')}} <span class="text-danger">*</span></label>
					<div class="col-md-8">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							...
							<div class="form-group row">
								...
								<div class="col-md-8">
									<input type="number" min="0" value="0" step="0.01" placeholder="{{ translate('Shipping cost') }}" name="flat_shipping_cost" class="form-control" >
								</div>
							</div>
						</div>
					</div>
