			...
			<div class="col text-center text-md-left">
              <address>
                  <strong class="text-main">{{ json_decode($order->shipping_address)->name }}</strong><br>
                   ...
                   {{ json_decode($order->shipping_address)->address }}, {{ isset(json_decode($order->shipping_address)->ward_name) ? json_decode($order->shipping_address)->ward_name : "" }}, {{ isset(json_decode($order->shipping_address)->district_name) ? json_decode($order->shipping_address)->district_name : "" }}, {{ json_decode($order->shipping_address)->city }}, {{ json_decode($order->shipping_address)->postal_code }}<br>
