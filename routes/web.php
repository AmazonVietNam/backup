...
Route::post('/users/login/post', 'HomeController@postLogin')->name('post.login');
...
Route::get('/minigame', 'HomeController@minigame')->name('minigame');
Route::get('/game3', 'HomeController@game3')->name('game3');
Route::get('/game{id}', 'HomeController@listingByEvents')->name('game');
Route::get('/contact-us', 'HomeController@contactus')->name('contact-us');
Route::post('/contact-us', 'ContactRequestController@store')->name('contact-us.store');
...
Route::get('/compare/add/{id}', 'CompareController@new_add')->name('compare.add');
Route::get('/compare/remove/{key}', 'CompareController@removeFromCompare')->name('compare.removeOne');
...
Route::group(['middleware' => ['user', 'verified','unbanned']], function(){
	...
	Route::get('/cart/remove/{key}', 'CartController@remove_cart')->name('cart.remove_cart');
	...
	Route::get('/wishlists/add/{id}', 'WishlistController@new_store')->name('wishlists.add');
	Route::get('/wishlists/remove/{id}', 'WishlistController@remove_new')->name('wishlists.remove_new');

	Route::get('/wallet', 'WalletController@index')->name('wallet.index');
	Route::post('/recharge', 'WalletController@recharge')->name('wallet.recharge');
	Route::post('/affiliate_recharge', 'WalletController@affiliate_recharge')->name('wallet.affiliate_recharge');
	...
	Route::get('/addresses/country/{id}', 'AddressController@getProvincesInContry')->name('addresses.getProvincesInCountry');
	Route::get('/addresses/province/{id}', 'AddressController@getDistrictsInProvince')->name('addresses.getDistrictsInProvince');
	Route::get('/addresses/district/{id}', 'AddressController@getWardsInDistrict')->name('addresses.getWardsInDistrict');
...
Route::group(['middleware' => ['auth']], function(){
	...
	Route::post('/dropzone/upload', 'ShopController@dropzone_upload')->name('dropzone.upload');
});
