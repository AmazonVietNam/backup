...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::resource('minigame','Events_gamesController');
	Route::get('/minigame/edit/{id}', 'Events_gamesController@edit')->name('events_games.edit');
	Route::get('/minigame/destroy/{id}', 'Events_gamesController@destroy')->name('events_games.destroy');
	...
	Route::group(['prefix' => 'website'], function(){
		...
		Route::get('/custom-pages', 'PageController@index')->name('custom-pages.index');
	...
	// contact requests
	Route::get('contact_requests', 'ContactRequestController@index')->name('contact_requests.index');
	Route::get('contact_requests/{id}', 'ContactRequestController@show')->name('contact_requests.show');
