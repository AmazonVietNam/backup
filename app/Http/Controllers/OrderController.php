...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('frontend-v2.user.seller.orders', compact('orders','payment_status','delivery_status', 'sort_search', 'from_date', 'to_date', 'product_name'));
    }
    ...
    public function update_delivery_status(Request $request)
    {
        ...
        flash(translate('Order status has been updated'))->success();
    ...
    public function update_payment_status(Request $request)
    {
        ...
        if($order->payment_status == 'paid' && $order->commission_calculated == 0){
            if(\App\Addon::where('unique_identifier', 'seller_subscription')->first() == null || !\App\Addon::where('unique_identifier', 'seller_subscription')->first()->activated){
                if ($order->payment_type == 'cash_on_delivery' || $order->payment_type == 'internet_banking') {
